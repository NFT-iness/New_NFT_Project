...
const transparentColor = new THREE.Color(0x000000);
...
function createWorld() {
  ...
  scene.background = new THREE.Color(transparentColor);
  //---
  camera = new THREE.PerspectiveCamera(55, _width/_height, 1, 1000);
  camera.position.z = 12; //sets zoom level
  //---
